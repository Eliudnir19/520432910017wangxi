/* autogenerated by Processing revision 1276 on 2021-11-21 */
...
public class Standard_Piano extends PApplet {
...
class PianoKey {
  ...
  PianoKey(String sampleName, int _xpos, int _ypos, int _wd, int _ht) {  //String是字符串的数据类型，文件名就是一个字符串
   ...
   public boolean isHover() {  //鼠标位置是否在琴键方块里
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Standard_Piano" };
    if (passedArgs != null) {
